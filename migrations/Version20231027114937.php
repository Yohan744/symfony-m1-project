 ...
 */
final class Version20231027114937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, town_hall_id, theme_id, password, xp_level, coins, email, roles FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, town_hall_id INTEGER DEFAULT NULL, theme_id INTEGER DEFAULT NULL, password VARCHAR(255) NOT NULL, xp_level INTEGER NOT NULL, coins INTEGER NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        ...
        $this->addSql('INSERT INTO user (id, town_hall_id, theme_id, password, xp_level, coins, email, roles) SELECT id, town_hall_id, theme_id, password, xp_level, coins, email, roles FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, town_hall_id INTEGER NOT NULL, theme_id INTEGER NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
